...
std::vector<glm::vec3> computeTranslationalSweep(const std::vector<glm::vec3> profileCurve, const std::vector<glm::vec3> trajectoryCurve)
{
	const auto trajectoryCurveDisplacements = computeDisplacements(trajectoryCurve);	// Compute trajectory curve displacements.
	...
	{
		for (auto profileVertex : profileCurve)
		{
